...
import {Users, UsersRound, Building2, ChartPie } from 'lucide-react'
const QuickActions = () => {
    return (
        <div>
            <section id='quick-actions' className="py-8 sm:py-12 md:py-16 h-auto sm:h-screen">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 px-4 sm:px-6 mt-6 sm:mt-8">
                    ...
                    <div className="rounded-lg bg-card text-card-foreground shadow-sm p-4 sm:p-6 hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:-translate-y-1 group border-[#E5DEFF] border-2">
                        <div className="flex flex-col items-center text-center">
                        <Users className="lucide lucide-user w-8 h-8 sm:w-12 sm:h-12 text-[#6B4AA0] mb-4 group-hover:scale-110 transition-transform duration-300"/>
                    ...
                    <div className="rounded-lg bg-card text-card-foreground shadow-sm p-4 sm:p-6 hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:-translate-y-1 group border-[#E5DEFF] border-2">
                        <div className="flex flex-col items-center text-center">
                        <UsersRound className="lucide lucide-user w-8 h-8 sm:w-12 sm:h-12 text-[#6B4AA0] mb-4 group-hover:scale-110 transition-transform duration-300"/>
                            <h3 className="text-lg sm:text-xl font-semibold mb-2">Active Voters</h3>
                            <p className="text-sm sm:text-base text-gray-600">See the full list of active voter.</p>
                        </div>
                    </div>
